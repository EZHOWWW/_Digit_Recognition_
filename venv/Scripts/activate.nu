...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\programming\languages\Python\Digit_Recognition\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\programming\languages\Python\Digit_Recognition\venv\Scripts\deactivate.nu'
